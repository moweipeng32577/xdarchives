...
@Entity
// @XmlRootElement(name="Tb_entry_index")
// @XmlAccessorType(XmlAccessType.FIELD)
public class Tb_entry_index {
	@Id
	...
	@Transient
	private String zoneShelves;//临时存放用,方便档案入库直接导入的使用
	...
	public String getZoneShelves() {
		return zoneShelves;
	}

	public void setZoneShelves(String zoneShelves) {
	...
	public String toString() {
		return "Tb_entry_index [entryid=" + entryid + ", nodeid=" + nodeid + ", tdn=" + tdn + ", nodefullname="
				...
				+ ", sparefield1=" + sparefield1 + ", sparefield2=" + sparefield2 + ", sparefield3=" + sparefield3
				+ ", sparefield4=" + sparefield4 + ", sparefield5=" + sparefield5 + "]";
	}
