 ...
 */
Ext.define('ClassifySearchDirectory.view.ReportGridView',{
    extend:'Comps.view.BasicGridView',
    xtype:'ReportGridView',
    region:'center',//比较元素占用的文档区域
    ...
    columns:[
        {text:'报表名称',dataIndex:'reportname',flex:2,menuDisabled:true/*禁用列菜单*/},
        {text:'模板名称',dataIndex:'nodul',flex:2,menuDisabled:true},
