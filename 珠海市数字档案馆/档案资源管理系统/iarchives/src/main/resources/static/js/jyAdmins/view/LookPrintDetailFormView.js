...
Ext.define('JyAdmins.view.LookPrintDetailFormView',{
    extend: 'Ext.form.Panel',
    xtype: 'lookPrintDetailFormView',
    itemId:'lookPrintDetailFormViewId',
    region: 'north',
    height:'50%',
    autoScroll: true,
    fieldDefaults: {
            ...
            listeners:{
                render:function (view) {
                    ...
                    Ext.Ajax.request({
                        ...
                        params:{
                            borrowcode:lookPrintDetailFormView.borrowcode
                        },
