...
Ext.define('PlaceOrder.view.PlaceOrderAuditFormView', {
    extend: 'Ext.panel.Panel',
    xtype: 'placeOrderAuditFormView',
    itemId: 'placeOrderAuditFormViewId',
    autoScroll: true,
    layout: 'fit',
    items: [{
        xtype: 'form',
            ...
            items: [
                {
                    ...
                    listeners: {
                        ...
                        select:function (view,record) {
                            var carOrderAuditFormView = view.findParentByType('placeOrderAuditFormView');
                    ...
                    listeners: {
                        ...
                        select: function (combo, record) {
                            var placeOrderAuditFormView = combo.findParentByType("placeOrderAuditFormView");
                            var spmanOrgan = placeOrderAuditFormView.down("[itemId=approveOrgan]");
                            spmanOrgan.select(null);
                            var nextSpman = placeOrderAuditFormView.down("[itemId=nextSpmanId]");
                            ...
                            spmanOrgan.getStore().proxy.extraParams.taskid = placeOrderAuditFormView.orderid;
                    ...
                    listeners:{
                        ...
                        select:function (combo,record) {
                            var spmancombo = combo.findParentByType("placeOrderAuditFormView").down("[itemId=nextSpmanId]");
    ...
    buttons: [{
        text: '提交',
        itemId: 'placeOrderApproveSubmit'
    }, {
        text: '关闭',
        itemId: 'placeOrderApproveClose'
    }]
});
