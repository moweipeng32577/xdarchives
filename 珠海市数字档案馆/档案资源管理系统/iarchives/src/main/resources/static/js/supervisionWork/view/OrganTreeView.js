...
Ext.define('SupervisionWork.view.OrganTreeView', {
    ...
    createPicker: function () {
        ...
        self.picker.on({
            itemclick: function (view, record, item, index, e, object) {
                ...
                self.submitText = record.get('text');
                var supervisionGuidanceView = view.findParentByType('supervisionWorkView');
                ...
                textLabel.setText('当前位置在 机构：' + record.get('text') + ' 年度：' + text);
