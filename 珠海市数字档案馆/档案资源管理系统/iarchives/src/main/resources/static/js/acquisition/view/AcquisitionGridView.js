 ...
 */
Ext.define('Acquisition.view.AcquisitionGridView',{
    extend:'Comps.view.EntryGridView',
    xtype:'acquisitiongrid',
    dataUrl:'/acquisition/entries',
    title:'当前节点：',
    tbar:{
...
//文件上传弹出框
Ext.define('Comps.view.AcUploadView', {
