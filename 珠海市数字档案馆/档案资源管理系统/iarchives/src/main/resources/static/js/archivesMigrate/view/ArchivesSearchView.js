...
Ext.define('ArchivesMigrate.view.ArchivesSearchView', {
    extend: 'Ext.panel.Panel',
    xtype:'archivesSearchView',
    layout:'card',
    activeItem:0,
    items:[{
        itemId:'gridview',
        ...
        items: [{
            ...
            items:[{
                ...
                handler:function(btn){
                    var grid = btn.findParentByType('archivesSearchView').down('archivesSearchGridView');
