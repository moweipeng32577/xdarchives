...
Ext.define('Acquisition.view.MissPageElectronicView', {
    ...
    items: [{
        ...
        listeners: {
            beforeload: function () {
                var view = this.findParentByType('missPageElectronicView');
                this.getStore().proxy.url = '/electronic/electronics/tree/capture' + '/' + view.entryid + '/' + window.wmedia;
            },
            ...
            itemclick: function (view, record, item, index, e, eOpts) {
                ...
                mediaFrame.setAttribute('src', '/electronic/media?entrytype=capture&eleid=' + record.get('fnid') + '&filetype=' + filename.substring(filename.lastIndexOf('.') + 1));
            }
        }
    }, {
        region: 'center',
