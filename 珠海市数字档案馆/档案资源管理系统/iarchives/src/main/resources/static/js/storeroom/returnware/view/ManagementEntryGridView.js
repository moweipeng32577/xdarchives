 ...
 */
Ext.define('ReturnWare.view.ManagementEntryGridView', {
    extend: 'Comps.view.EntryGridView',
    xtype: 'managementgrid',
    dataUrl: '/management/storageNoEntries',
    /*tbar: {
...
//文件上传弹出框
Ext.define('Comps.view.MUploadView', {
    ...
    items: {
        ...
        tbar: [{
            ...
            handler: function () {
                ...
                Ext.Msg.wait('正在进行上传文件,请耐心等候......', '正在操作');
                win.uploader.upload();
            }
        }]
    },
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function (response, opts) {
                                ...
                                if (failureCount > 0) {
                                    ...
                                    /*Ext.Msg.show({
                                     title: '导入结果提示',
                                     message: '存在档号重复条目,条目数：'+failureCount + '<br>' + '点击“下载”下载条目失败信息',
