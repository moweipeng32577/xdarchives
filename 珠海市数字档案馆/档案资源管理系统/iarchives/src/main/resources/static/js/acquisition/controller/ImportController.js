...
var UnZipPath = "";
var impCountMsg = "";
Ext.define('Acquisition.controller.ImportController', {
        ...
        this.control({
            ...
            '[itemId=impBtn]': {
                click: function (btn) {
                    ...
                    var exportMissView = Ext.create('Acquisition.view.ImportMsgView');
    ...
    afterrender: function (panel) {
        ...
        var fnid = panel.up('acquisitiongrid').nodeid;
        var text = panel.up('acquisitiongrid').nodefullname;
