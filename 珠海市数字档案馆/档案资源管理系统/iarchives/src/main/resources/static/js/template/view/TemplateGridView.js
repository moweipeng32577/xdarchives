...
Ext.define('Template.view.TemplateGridView', {
...
//    }],
    ...
    columns: [
        ...
        {text: '元数据编码', dataIndex: 'metadatatype', flex: 2, menuDisabled: true},
        {text: '元数据描述', dataIndex: 'metadatafieldname', flex: 2, menuDisabled: true},
                ...
                Ext.Ajax.request({
                    ...
                    success: function (opts) {
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function (opts){
                                RealoadtemplateView.down('templateGridView').getStore().reload();
                            }
                        })
                        // Ext.Ajax.request({
                        //     method: 'POST',
