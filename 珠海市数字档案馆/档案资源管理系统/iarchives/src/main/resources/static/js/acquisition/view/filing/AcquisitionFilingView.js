 ...
 */
Ext.define('Acquisition.view.filing.AcquisitionFilingView', {
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [/*{
                     ...
                     style:'font-size:18px;color:red;line-height:18px',
                     margin:'0 0 0 5',
                     html:'设置多条未归记录同时加入预归档时，先后排序方式。<br/>'
                     },{
                     xtype: 'label',
                     hidden:true,
                     //itemId:'ordertxtId',
                     style:'font-size:18px;color:blue;line-height:18px',
                     margin:'0 0 0 5',
                     html:'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
                     },*/{
