...
Ext.define('CarOrder.view.CarOrderFormView', {
    extend: 'Ext.window.Window',
    xtype: 'carOrderFormView',
    itemId: 'carOrderFormViewId',
    autoScroll: true,
    width: '70%',
    height: '60%',
        ...
        items: [
            {
                ...
                listeners: {
                    ...
                    select:function (combo,record) {
                        var spmanOrgan = combo.findParentByType("carOrderFormView").down("[itemId=approveOrgan]");
                        spmanOrgan.select(null);
                        var spman = combo.findParentByType("carOrderFormView").down("[itemId=spmanId]");
                        spman.select(null);
                ...
                listeners: {
                    ...
                    select:function (combo,record) {
                        var spmancombo = combo.findParentByType("carOrderFormView").down("[itemId=spmanId]");
    ...
    buttons: [
        {text: '提交', itemId: 'carOrderSubmit'},
        {text: '关闭', itemId: 'carOrderClose'}
    ]
});
