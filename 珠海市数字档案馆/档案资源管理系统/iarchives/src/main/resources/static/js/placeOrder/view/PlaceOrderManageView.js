...
Ext.define('PlaceOrder.view.PlaceOrderManageView', {
                    ...
                    items:[{
                        ...
                        listeners: {
                            ...
                            select:function (view,record) {
                                var southgrid = view.up('placeOrderManageView').down('[itemId=southgrid]');
                                var placeOrderManageGridView = view.up('placeOrderManageView').down('placeOrderManageGridView');
