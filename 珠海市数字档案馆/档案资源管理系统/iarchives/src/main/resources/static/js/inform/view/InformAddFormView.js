 ...
 */
Ext.define('Inform.view.InformAddFormView', {
    informid:'',
    extend: 'Ext.window.Window',
    xtype: 'informAddFormView',
    itemId:'informAddFormViewId',
    frame: true,
    resizable: true,
    flag:'',
    width: '60%',
    ...
    items: [
        {
            ...
            height:138,
            items: [
                {columnWidth: 1, fieldLabel: '', name: 'id', hidden: true},
                {columnWidth: 1, fieldLabel: '标题', name: 'title', allowBlank: false},
                {
                    columnWidth: 1,
                    fieldLabel: '到期时间',
                    name: 'limitdate',
    ...
    buttons: [
        { text: '推送到用户',itemId:'formPostedUser'},
        { text: '推送到用户组',itemId:'formPostedUsergroup'},
        { text: '提交',itemId:'informAddSubmit'},
        { text: '关闭',itemId:'informAddClose'}
    ]
});
//文件上传弹出框
