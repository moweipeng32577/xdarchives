 ...
 *根据文件编码获得文件内容
 * Created by Leo on 2019/5/28 0028.
 */
public class EncodingDetect {
    public static void main(String[] args) {
        String file = "E:/xd-solidify/source22/啊啊啊.txt";
    ...
    public static Map<String,String> readThematicFile(String file, String code) {
...
//                }
                ...
                map.put(str,line.substring(str.length()+1, line.length()));
                // 每一行创建一个Student对象，并存入数组中
