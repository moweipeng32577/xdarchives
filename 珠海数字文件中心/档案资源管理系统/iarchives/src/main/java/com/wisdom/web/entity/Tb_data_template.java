...
public class Tb_data_template {
	...
	@Column(columnDefinition = "char(1)")
	private boolean archivecodeedit;
	@Column(columnDefinition = "char(36)")
	...
	public boolean getArchivecodeedit() {
		return archivecodeedit;
	}

	public void setArchivecodeedit(boolean archivecodeedit) {
		this.archivecodeedit = archivecodeedit;
	}
}
