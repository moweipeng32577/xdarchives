...
public class Tb_user_sx implements UserDetails, Serializable {
	...
	private Tb_right_organ_sx organ;
	...
	public Tb_right_organ_sx getOrgan() {
		return organ;
	}

	public void setOrgan(Tb_right_organ_sx organ) {
		this.organ = organ;
	}
	...
	public Tb_user_sx(String userid, String realname) {
		this.userid = userid;
		this.realname = realname;
	}

	public Tb_user_sx(String loginname, String realname, String sex, String phone, String address, String letternumber, String remark, String infodate, String birthday, String ethnic) {
	...
	public void setOrganid(String organid) {
		...
		Tb_right_organ_sx node = new Tb_right_organ_sx();
