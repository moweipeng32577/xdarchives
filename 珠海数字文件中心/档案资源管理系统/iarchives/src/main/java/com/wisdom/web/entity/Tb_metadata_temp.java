...
public class Tb_metadata_temp {
    ...
    public String getFieldgid() {
        return fieldgid;
    }

    public void setFieldgid(String fieldgid) {
    ...
    public String getFenums() { return fenums; }

    public void setFenums(String fenums) { this.fenums = fenums; }
