...
Ext.define('SimpleSearch.view.SimpleSearchView', {
    ...
    items:[{
        ...
        items: [{
            ...
            items:[{
                ...
                hidden:false//titleflag == "2"?false:true
            },{
                xtype: "radiogroup",
                columnWidth: .2,
                itemId:'datasoure2',
                ...
                labelWidth: 50,
                items:[
                    {boxLabel: '档案资源管理系统',inputValue: 'management',checked:'true'},
                    {boxLabel: '声像档案管理系统',inputValue: 'soundimage'}
                ],
