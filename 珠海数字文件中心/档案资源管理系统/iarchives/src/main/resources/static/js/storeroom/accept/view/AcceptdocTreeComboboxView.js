 ...
 */
Ext.define('Accept.view.AcceptdocTreeComboboxView', {
    ...
    createPicker: function () {
        ...
        self.picker.on({
            itemclick: function (view, recore) {
                self.findParentByType('AcceptAddDocForm').down('[itemId=parentItemID]').setValue(recore.get('fnid'));
                ...
                if (!self.multiSelect) {
                    ...
                    var fullname=recore.get('text');
                    while(recore.parentNode.get('text')!='Root'){
                        fullname=recore.parentNode.get('text')+'_'+fullname;
                        recore=recore.parentNode;
                    }
