...
Ext.define('Template.view.TemplateDetailView', {
        ...
        items:[{
            ...
            items:[{
                ...
                items: [{
                    ...
                    listeners:{
                        expand:function(view,combo){
                            var templateDetailView = view.findParentByType('templateDetailView');
                            var metadatatype = templateDetailView.down('[name=metadatatype]');
                            if(!metadatatype.getValue()){
                                XD.msg('请选择元数据类型！');
                                return;
                            }
                            view.getStore().proxy.extraParams.metadataType=metadatatype.getValue();
                            view.getStore().reload();
                        },
                        select:function(combo,records){
                            var templateDetailView = combo.findParentByType('templateDetailView');
                            var metadatafieldname = templateDetailView.down('[itemId=metadatafieldname]');
                            metadatafieldname.setValue(records.data.fieldname);
                            // console.log(records.data.fieldname);
                        },
                    }
                }),{
                    xtype:'textfield',
