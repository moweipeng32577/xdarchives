...
Ext.define('CarOrder.view.CarOrderAuditFormView', {
            ...
            items: [
                {
                    ...
                    listeners: {
                        ...
                        select:function (view,record) {
                            ...
                            var nextSpmanId=carOrderAuditFormView.down('[itemId=nextSpmanId]');
                            var nextNodeId=carOrderAuditFormView.down('[itemId=nextNodeId]');
                            addprove.setValue(record.get('Value'));
                            if(record.get('Value')=="不同意"){
                                nextSpmanId.setValue("");
                                nextNodeId.setValue("")
                            }
                        }
                    }
