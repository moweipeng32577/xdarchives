...
Ext.define('ThematicUtilize.controller.ThematicUtilizeController', {
        ...
        for(var i=0;i<thematicUtilizeView.acrossSelections.length;i++){
            setTimeout(function(thematicid,name){
                ...
                Ext.Ajax.request({
                    ...
                    url: '/thematicMakeUtilize/getThematicFile',
                    method: 'POST',
                    sync: true,
                    success: function (resp) {
                        ...
                        if (respText.success == true) {
                            ...
                            downloadForm.action = '/thematicMakeUtilize/downloadZt/'+thematicid;
                            downloadForm.submit();
                        }else{
    ...
    itemdblclickHandler: function (view, item) {
        var downloadForm = document.createElement("form");
        document.body.appendChild(downloadForm);
        downloadForm.action = '/thematicMakeUtilize/downloadZt/'+item.data.thematicid;
        downloadForm.submit();
    },
