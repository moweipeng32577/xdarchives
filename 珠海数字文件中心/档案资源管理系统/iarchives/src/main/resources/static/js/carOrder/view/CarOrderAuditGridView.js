...
Ext.define('CarOrder.view.CarOrderAuditGridView',{
    extend:'Comps.view.BasicGridView',
    xtype:'carOrderAuditGridView',
    itemId:'carOrderAuditGridViewID',
    searchstore:[
    ...
    tbar:{
        ...
        items:[{
            ...
            itemId:'carOrderAudit'
        }]
    },
    store: 'CarOrderAuditGridStore',
    columns: [
