Ext.define('DigitalProcess.view.EntryFormView1',{
    ...
    items:[
        ...
        // items:[
            ...
            //         {   xtype: "combobox",
            //             name: "operateUser",
            //             itemId:'operateUserId',
            //             fieldLabel: "录入人",
            //             columnWidth:1,
            //             margin:'0 10 0 10',
            //             store: 'OperateUserStore',
            //             editable: false,
    ...
    //     // layout: 'fit',
    //     // items: [{
    //     //     html:'<div id="p2" class="pw-view"></div>'
    //     // }]
    // },{
    //     title:'利用文件',
    //     hidden:true,
    ...
    items: [{
        ...
        listeners: {
            beforeload: function () {
                ...
                this.getStore().proxy.url = '/electronic/electronics/tree/'+ view.entryid ;
            },
            ...
            itemclick: function ( view, record, item, index, e, eOpts )  {
                ...
                mediaFrame.setAttribute('src', '/digitalProcess/toShowMedia?&eleid=' + record.get('fnid') + '&filetype=' + filename.substring(filename.lastIndexOf('.') + 1));
            }
        }
    }, {
        region: 'center',
...
Ext.define('DigitalProcess.view.DynamicFormView',{
