 ...
 */
Ext.define('ClassifySearch.view.ClassifyLookAddMxGridView', {
    extend: 'Comps.view.BasicGridView',
    xtype: 'classifylookAddMxGridView',
    itemId: 'classifylookAddMxGridViewId',
    region: 'center',
    hasSearchBar: false,
    tbar: [{
        itemId: 'stAddSq',
    ...
    store: 'ClassifyLookAddMxGridStore',
    columns: [
