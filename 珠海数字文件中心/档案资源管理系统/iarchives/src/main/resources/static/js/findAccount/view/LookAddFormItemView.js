...
Ext.define('FindAccount.view.LookAddFormItemView', {
    extend: 'Ext.form.Panel',
    xtype: 'lookAddFormItemView',
    itemId: 'lookAddFormItemViewId',
    autoScroll: true,
    fieldDefaults: {
        labelWidth: 70
    },
        ...
        {xtype: 'textfield', name: 'ethnic',itemId:'ethnic', hidden: true},//查档者民族
        {
            ...
            listeners: {
                ...
                beforerender: function (combo) {
                    ...
                    store.proxy.extraParams.istemporary=true;
    ...
    buttons: [
        {text: '读取身份证',itemId:'readuid',handler: function () {
            ...
            if (resultObj.resultFlag == 0) {
                ...
                this.up('electronFormItemView').down('[itemId=ethnic]').setValue(resultObj.resultContent.nation);//民族
        ...
        {text: '提交', itemId: 'lookAddFormSubmit'},
        {text: '关闭', itemId: 'lookAddFormClose'}
    ]
});