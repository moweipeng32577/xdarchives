...
Ext.define('ElectronPrintApprove.view.ElectronicView', {
            ...
            items: [
                ...
                },
                {
                    ...
                    xtype: 'button', text: '返回', handler: function () {
                        ...
                        var mediatext = view.getEvidenceText(view.entryid);
    ...
    listeners: {
        render: function (win) {
            ...
            win.uploader.on('uploadSuccess', function (file, response) {
                Ext.Ajax.request({
                    method: 'POST',
                    url: '/electronic/ztelectronics/borrowApprove/' + win.entryid + '/' + file.name + '/',
                    success: function (response, opts) {
