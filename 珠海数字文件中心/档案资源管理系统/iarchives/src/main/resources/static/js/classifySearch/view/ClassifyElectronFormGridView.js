 ...
 */
Ext.define('ClassifySearch.view.ClassifyElectronFormGridView', {
    extend: 'Comps.view.BasicGridView',
    xtype: 'classifyElectronFormGridView',
    itemId: 'classifyElectronFormGridViewId',
    region: 'south',
    height: '57%',
    store: 'ClassifyElectronFormGridStore',
    hasSearchBar: false,
    columns: [
