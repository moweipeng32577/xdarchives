...
Ext.define('PavilionSearch.view.PavilionSearchView', {
    ...
    items:[{
        ...
        items: [{
            ...
            items:[{
                ...
                columnWidth: .1,
                xtype : 'combo',
                itemId:'pavilionSearchSearchComboId',
                store : [['title','题名'],
                    ['archivecode','档号'],
                    ['filedate','文件日期'],
                    ['responsible','责任者'],
                ...
                columnWidth: .3,
                xtype: 'searchfield',
                itemId:'pavilionSearchSearchfieldId',
                style: "margin-right:2px"
            },/*{
                columnWidth: .09,
                xtype: 'checkboxfield',
                ...
                handler:function(btn){
                    var grid = btn.findParentByType('pavilionSearchView').down('pavilionSearchGridView');
