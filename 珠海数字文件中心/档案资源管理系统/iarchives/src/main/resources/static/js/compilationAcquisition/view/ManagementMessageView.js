 ...
 */
Ext.define('CompilationAcquisition.view.ManagementMessageView', {
    extend: 'Ext.window.Window',
    xtype: 'ManagementMessage',
    itemId: 'ManagementMessage',
    title: '输入导出后的文件名',
    width: 450,
    height: 200,
    modal: true,
            ...
            items: [{
                ...
                items: [{
                    ...
                    handler:function (obj) {
                        var exportMessageView = obj.up('ManagementMessage')
