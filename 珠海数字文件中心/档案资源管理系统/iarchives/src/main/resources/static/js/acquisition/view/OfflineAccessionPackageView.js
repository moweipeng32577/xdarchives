 ...
 * 查看数据包
 */
Ext.define('Acquisition.view.OfflineAccessionPackageView',{
    ...
    items: [{
        ...
        folderSort : true ,
        store: {
            model: 'Acquisition.model.OfflineAccessionResultGridModel',
            proxy: {
                type: 'ajax',
                url: '/offlineAccession/showOAVerifyPackage',
            ...
            listeners: {
                beforeload: function (){
                    this.proxy.extraParams.filename = window.filename;
                }
            }
        }
    }, {
        ...
        items:{
            ...
            store:{
                ...
                proxy: {
                    type: 'ajax',
                    url: '/offlineAccession/getDataView',
                    extraParams: {
                        childrens:''
                    },
                    reader: {
        ...
        items:{
            ...
            items:{
                ...
                items:[
                    ...
                    {xtype: 'textfield',readOnly:true, fieldLabel: '全宗号<span style="color:red">(必填)</span>',name:'全宗号'},
                    ...
                    {xtype: 'textfield',readOnly:true, fieldLabel: '文件编号<span style="color:red">(必填)</span>',name:'文件编号'},
                    {xtype: 'textfield',readOnly:true, fieldLabel: '电子文件名<span style="color:red">(必填)</span>',name:'文件名称'},
                    {xtype: 'textfield',readOnly:true, fieldLabel: '开放审核<span style="color:red">(必填)</span>',name:'开放审核'},
                    {xtype: 'textfield',readOnly:true, fieldLabel: '保管期限<span style="color:red">(必填)</span>',name:'保管期限'},
                    {xtype: 'textfield',readOnly:true, fieldLabel: '归类<span style="color:red">(必填)</span>',name:'报文类别名称'},
                    {xtype: 'textfield',readOnly:true, fieldLabel: '文件形成单位名称<span style="color:red">(必填)</span>',name:'文件形成单位名称'},
                    {xtype: 'textfield',readOnly:true, fieldLabel: '文件形成时间<span style="color:red">(必填)</span>',name:'文件形成时间'},
