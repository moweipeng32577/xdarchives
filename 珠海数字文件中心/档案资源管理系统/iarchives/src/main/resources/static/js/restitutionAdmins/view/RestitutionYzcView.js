 ...
 */
Ext.define('Restitution.view.RestitutionYzcView',{
    extend:'Comps.view.BasicGridView',
    xtype:'restitutionYzcView',
    itemId:'restitutionYzcViewID',
    searchstore:[
    ...
    columns: [
        ...
        {text: '转出时间', dataIndex: 'returntime', flex: 2, menuDisabled: true},
        {text: '转出人账号', dataIndex: 'returnloginname', flex: 2, menuDisabled: true},
        {text: '转出人', dataIndex: 'returnware', flex: 2, menuDisabled: true},
