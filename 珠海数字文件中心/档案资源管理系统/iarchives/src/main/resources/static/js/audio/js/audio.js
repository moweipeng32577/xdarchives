;(function(window,document) {
    ...
    var audioHtml = '<div class="audio-container"><div class="audio-view"><div class="audio-cover"></div>' +
        '<div class="audio-body"><h3 class="audio-title">未知歌曲</h3><div class="audio-backs">' +
        '<div class="audio-this-time">00:00</div><div class="audio-count-time">00:00</div>' +
        '<div class="audio-setbacks">' +
        '<i class="audio-this-setbacks"><span class="audio-backs-btn"></span></i>' +
        '<span class="audio-cache-setbacks"></span></div></div></div>' +
        '<div class="audio-btn"><div class="audio-select">' +
        '<div action="play" data-on="icon-play" data-off="icon-pause" class="icon-play" style="padding-right: 30px"></div>' +
        '<div action="volume" class="icon-volume-up">' +
        '<div class="audio-set-volume"><div class="volume-box"><i><span  class="audio-backs-btn"></span></i></div>' +
	...
	window[fnName] = function(setConfig){
        ...
        var audioBox = document.getElementsByClassName('audio-box')[0];
        audioBox.innerHTML = audioHtml;
