...
Ext.define('Acquisition.view.AcquisitionExportMissView', {
    extend: 'Ext.window.Window',
    xtype: 'acquisitionExportMissView',
    itemId: 'acquisitionExportMissViewId',
    title: '输入导出后的文件名',
    width: 450,
    height: 200,
    modal: true,
            ...
            items: [{
                ...
                items: [{
                    ...
                    handler:function (obj) {
                        var exportMessageView = obj.up('acquisitionExportMissView');
